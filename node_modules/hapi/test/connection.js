    ...
    describe('route()', function () {
        ...
        it('adds routes using single and array methods', function (done) {
            ...
            server.route([
                {
                    method: 'GET',
                    path: '/helper/products',
                    handler: function (request, reply) { return reply(); }
                },
                {
                    method: 'GET',
                    path: '/helper/products/{id}',
                    handler: function (request, reply) { return reply(); }
                },
                {
                    method: 'POST',
            ...
            expect(paths).to.only.deep.include([
                { method: 'get', path: '/helper/products' },
                { method: 'get', path: '/helper/products/{id}' },
                { method: 'post', path: '/helper/products' },
                { method: 'put', path: '/helper/products/{id}' },
                { method: 'patch', path: '/helper/products/{id}' },
                { method: 'delete', path: '/helper/products/{id}' }
            ]);
            done();
        });
    });
